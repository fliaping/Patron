...
public class Config {
    ...
    public static final String VIDEO_AUDIO = "audio_record";  //声音录制是否开启
    ...
    private void initSetMap(){
        ...
        //状态信息
        setMap.put(IS_VID_REC,0);
        setMap.put(IS_RMT_V_REC,0);
        setMap.put(IS_RTSP_RUN,0);
    ...
    public static final String RETURN_BROADCAST = "com.deepwits.Patron.return_action";
